    ...
    <div className="text-stone-500 flex flex-col gap-2">
      ...
      <div className="flex flex-wrap justify-start items-center gap-2">
        {timeSlots.map((timeSlot) => (
          <span
            className={`${occupied.includes(timeSlot) ? 'bg-stone-200' : 'bg-[#7C51C2]'} ${occupied.includes(timeSlot) ? 'text-stone-700' : 'text-stone-50'}  w-[4rem] p-1 flex justify-center items-center text-sm rounded-full cursor-pointer`}
          >
